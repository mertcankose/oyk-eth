...
const Final = () => {
  ...
  useEffect(() => {
    if (isConnected && walletProvider) {
      const newProvider = new BrowserProvider(walletProvider); // BrowserProvider, ethers.js kütüphanesinin bir parçasıdır ve tarayıcı tabanlı cüzdan etkileşimleri için bir arayüz sağlar.
  ...
  const initContracts = async () => {
    try {
      ...
      const signer = await provider.getSigner(); // provider'dan signer alıyoruz
