...
contract QuestionAnswer is Ownable {
    ...
    modifier notUpvoted(uint256 _answerId) {
        require(
            !hasUpvoted[msg.sender][_answerId],
            "Already upvoted this answer"
        );
        _;
    }
    ...
    function upvoteAnswer(
        ...
        require(
            oykToken.transferFrom(msg.sender, address(this), UPVOTE_FEE),
        ...
        // Transfer to author
        require(
            oykToken.transfer(answer.author, authorPayment),
            "Author payment failed"
        );
